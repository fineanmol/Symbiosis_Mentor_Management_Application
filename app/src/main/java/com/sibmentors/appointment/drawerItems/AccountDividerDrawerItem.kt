...
class AccountDividerDrawerItem : AbstractDrawerItem<AccountDividerDrawerItem, AccountDividerDrawerItem.ViewHolder>(),
    IProfile<AccountDividerDrawerItem> {
    ...
    override fun bindView(holder: ViewHolder, payloads: MutableList<Any>) {
        ...
        holder.divider.setBackgroundColor(
            UIUtils.getThemeColorFromAttrOrRes(
                ctx,
                com.mikepenz.materialdrawer.R.attr.material_drawer_divider,
                com.mikepenz.materialdrawer.R.color.material_drawer_divider
            )
        )
